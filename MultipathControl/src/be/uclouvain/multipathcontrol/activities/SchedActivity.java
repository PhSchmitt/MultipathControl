 ...
 * extended by scheduler selection 2015 - TU Kaiserslautern - Philipp Schmitt <k_schmitt12@cs.uni-kl.de>
 *
...
public class SchedActivity extends ListActivity {
	public void onCreate(Bundle icicle) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_list_item_1, Sysctl.getAvScheds());
		setListAdapter(adapter);
		setSelected(Config.scheduler);
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (!Config.scheduler.equals(item) && Sysctl.setScheduler(item)) {
			setSelected(item);
			Config.scheduler = item;
			Config.saveStatus(getApplicationContext());
		} else
			Toast.makeText(SchedActivity.this, "Not able to set " + item,
